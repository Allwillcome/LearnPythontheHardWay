...
class Engine(object):
    ...
    def __init__(self, scene_map, hero):
        # self.scenc_map 看似我用，其实是作者为了保证代码的整洁
        self.scene_map = scene_map
        self.hero = hero
    # 定义游戏阶段
    def play(self):
        #将 self 中的场景，打开secen_map.opening_scene的函数
        current_scene = self.scene_map.opening_scene()
        # 只有当在 228 win 的场景里，返回 0，才执行下面的操作
        while True:
            print "\n--------"
...
# 执行 36 行的 play 函数，注释掉本行代码后没有办法运行程序
a_game.play()